...
[![Test](https://img.shields.io/github/actions/workflow/status/libtnb/chi-skeleton/test.yml?branch=main&label=test)](https://github.com/libtnb/chi-skeleton/actions/workflows/test.yml)
[![Lint](https://img.shields.io/github/actions/workflow/status/libtnb/chi-skeleton/lint.yml?branch=main&label=lint)](https://github.com/libtnb/chi-skeleton/actions/workflows/lint.yml)
[![Go Version](https://img.shields.io/github/go-mod/go-version/libtnb/chi-skeleton)](go.mod)
[![License](https://img.shields.io/github/license/libtnb/chi-skeleton)](LICENSE)

A modular monolith skeleton for Go web applications, built on
[chi](https://github.com/go-chi/chi) and `net/http`.
Prefer Fiber? See [fiber-skeleton](https://github.com/libtnb/fiber-skeleton).
...
- **Validation** — request binding ([chix](https://github.com/libtnb/chix)) with a boolean rule DSL and i18n messages ([validator](https://github.com/libtnb/validator))
...
- **Sessions** — database-backed ([sessions](https://github.com/libtnb/sessions)), started for every request except health probes
- **Logging** — structured [slog](https://pkg.go.dev/log/slog) to a rotating file and/or stdout; access logs ([httplog](https://github.com/golang-cz/httplog)) share the logger
